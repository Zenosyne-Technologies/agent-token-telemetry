...
- [ ] **Step 2: Write `.claude-plugin/marketplace.json`** (lets the repo be added as a local marketplace: `claude plugin marketplace add ~/Dev/agent-token-telemetry`)
...
1. `claude plugin marketplace add ~/Dev/agent-token-telemetry`
