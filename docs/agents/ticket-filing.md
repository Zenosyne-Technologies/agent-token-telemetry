...
Tracker: **JIRA project AgentOS (key AOS)** at example.atlassian.net (modern scrum template). Until a JIRA/Confluence intake guide exists, THIS file is authoritative. (The former Linear "Issue Intake & Triage Guide" is superseded — Linear is no longer the tracker as of 2026-08-03.)
